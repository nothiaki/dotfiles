...
-- Neo-tree
keymap.set("n", "<leader>e", "<cmd>Neotree toggle right<CR>")
...
keymap.set('n', '<leader>nd', '<cmd>lua vim.diagnostic.goto_prev()<CR>')
keymap.set('n', '<leader>pd', '<cmd>lua vim.diagnostic.goto_next()<CR>')
